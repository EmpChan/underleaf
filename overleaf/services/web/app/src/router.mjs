...
async function initialize(webRouter, privateApiRouter, publicApiRouter) {
  ...
  webRouter.get('/sign-up', UserPagesController.signupPage)
  AuthenticationController.addEndpointToLoginWhitelist('/sign-up')

  webRouter.post(
    '/sign-up',
    RateLimiterMiddleware.rateLimit(overleafLoginRateLimiter),
    CaptchaMiddleware.validateCaptcha('signup'),
